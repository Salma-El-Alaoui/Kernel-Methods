...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  2 17:43:35 2017
...
#print(interpolate_orientation(orientation, 32, 32, nbins = 18, signed_orientation = True))
#print(interpolate(magnitude, orientation, 4, 4, 32, 32, 8, 8, signed_orientation=True, nbins = 18)[0,0,2:4])
#
#print(compute_coefs(4, 4, 2, 2, 8, 8)[0:6,0:6])